...
import com.android.launcher3.CardinalLauncher;
import com.android.launcher3.CardinalLauncherModelDelegate;
...
public class SmartspaceViewContainer extends FrameLayout implements PluginListener<BcSmartspaceDataPlugin> {
    ...
    public SmartspaceViewContainer(Context context, AttributeSet attributeSet) {
        ...
        CardinalLauncher launcher = (CardinalLauncher) ActivityContext.lookupContext(context);
        launcher.getLauncherUnlockAnimationController().setSmartspaceView(mView);

        CardinalLauncherModelDelegate delegate = (CardinalLauncherModelDelegate) launcher.getModel().getModelDelegate();
    ...
    public void onPluginDisconnected(BcSmartspaceDataPlugin plugin) {
        CardinalLauncher launcher = (CardinalLauncher) ActivityContext.lookupContext(getContext());
