...
public class CardinalLauncherModelDelegate extends QuickstepModelDelegate
    implements SmartspaceSession.OnTargetsAvailableListener {

    public static final String TAG = "CardinalLauncherModelDelegate";
    ...
    public CardinalLauncherModelDelegate(Context context) {
        super(context);
        mContext = context;
    }
